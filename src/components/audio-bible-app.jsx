    ...
    <div style={defaultBackgroundStyle}>
      <ThemeProvider theme={theme}>
        {!isPlaying && isMobileSize && selectedLanguage && (
          <Box sx={{ pb: 7 }} ref={ref}>
            <CssBaseline />
            {(menuValue===settingsMenuIndex) && <SettingsView onConfirmClick={()=>setMenuValue(1)}/>}
        ...
        {!isPlaying && !selectedLanguage && <SettingsView onConfirmClick={()=>setMenuValue(1)}/>}
        {!isPlaying && !isMobileSize && selectedLanguage && (
          <Box sx={{ display: 'flex' }}>
        ...
        {isPlaying && (menuValue===settingsMenuIndex) && <SettingsView onConfirmClick={()=>setMenuValue(1)}/>}
