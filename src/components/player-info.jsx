...
export const PlayerInfo = (props) => {
  ...
  if (serie != null) {
    if (episode?.bibleType) {
      ...
      serie.episodeList != null &&
      episode != null &&
      serie.episodeList[0] != null
    ) {
      ...
      <div style={styles.scrubber} onClick={clickedScrubber}>
        ...
        <div style={styles.infotext}>
          <div style={styles.time}>
            <div style={styles.played}>{ms(curSec)}</div>/
            <div style={styles.duration}>{ms(curDur)}</div>
          </div>
          <div style={styles.programinfo}>
            ...
            {serie && <div style={styles.audioDescr} />}
            {hasButton && (
              <Button
                href={btnUrl}
                variant="contained"
